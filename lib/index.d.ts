...
export { type UseStore, getCurrentInstance, onBeforeRouteLeave, onBeforeRouteUpdate, useContext, useLink, useRoute, useRouteParams, useRouteQuery, useRouter, useStore, wrapProperty };
